...
class DBOperation():
    ...
    def __init__(self):
        ...
        file.close()
        self.mydb=mysql.connector.connect(host="localhost",user="root",passwd="Mayur@2064",database="vehicle_parking")
    ...
    def CreateTables(self):
        ...
        cursor.execute("CREATE TABLE admin (id int AUTO_INCREMENT PRIMARY KEY,username varchar(30),password varchar(30),created_at varchar(30))")
        cursor.execute("CREATE TABLE slots (id int AUTO_INCREMENT PRIMARY KEY,vehicle_id varchar(30),space_for int(25),is_empty int(25))")
        cursor.execute("CREATE TABLE vehicles (id int AUTO_INCREMENT PRIMARY KEY,name varchar(30),mobile varchar(30),entry_time varchar(30),exit_time varchar(30),is_exit varchar(30),vehicle_no varchar(30),vehicle_type varchar(30),created_at varchar(30),updated_at varchar(30))")
        cursor.close()
    ...
    def doAdminLogin(self,username,pasword):
        cursor=self.mydb.cursor()
        cursor.execute("select * from admin where username like'"+username+"' and password like'"+pasword+"'")
